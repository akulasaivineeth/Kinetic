...
export const workoutLogSchema = z.object({
  ...
  squat_reps: z.number().min(0).max(10000).default(0),
...
export const performanceGoalsSchema = z.object({
  ...
  squat_weekly_goal: z.number().min(1).max(100000).default(300),
  ...
  squat_peak_goal: z.number().min(1).max(10000).default(50),
});
